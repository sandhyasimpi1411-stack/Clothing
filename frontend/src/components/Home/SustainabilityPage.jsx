...
//       {/* HERO BANNER */}
//       <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-[#eae0d1]">
//         {/* Accent Background */}
...
//               <div className="inline-flex p-3 bg-[#eae0d1] rounded-xl mb-6">
...
//             <div className="w-20 h-20 bg-[#eae0d1] rounded-2xl flex items-center justify-center shadow-lg">
//               <Sprout className="w-10 h-10 text-gray-900" />
//             </div>
//             <div>
...
//                           <CheckCircle className="w-4 h-4 text-[#B89A67]" />
...
//               {/* Timeline line */}
//               <div className="hidden md:block absolute left-0 right-0 top-1/2 h-0.5 bg-gradient-to-r from-[#B89A67] via-[#D4B483] to-[#B89A67] -translate-y-1/2"></div>
...
//                       <div className="w-24 h-24 bg-white border-4 border-[#D4B483] rounded-full flex items-center justify-center mx-auto shadow-2xl group-hover:scale-110 transition-transform duration-300">
//                         <div className="w-20 h-20 bg-gradient-to-br from-[#B89A67] to-[#D4B483] rounded-full flex items-center justify-center text-white">
//                           {step.icon}
//                         </div>
//                       </div>
...
//                       </div>
//                     </div>
//                     <h4 className="font-bold text-gray-900 text-xl mb-2 group-hover:text-[#B89A67] transition-colors">
//                       {step.title}
//                     </h4>
...
//       <section className="py-16 w-full px-4 md:px-8 lg:px-16 bg-white">
//         <motion.div
//           initial="hidden"
//           whileInView="visible"
//           viewport={{ once: true }}
...
//           <motion.div
//             variants={itemVariants}
//             className="w-full bg-gradient-to-br from-gray-900 to-gray-800 p-12 rounded-2xl shadow-2xl text-white"
//           >
//             <div className="text-center mb-12">
//               <div className="inline-flex p-3 bg-[#B89A67]/20 rounded-xl mb-6">
//                 <Award className="w-8 h-8 text-[#B89A67]" />
//               </div>
...
//                 </div>
//                 <div className="flex items-center gap-3">
//                   <Mountain className="w-5 h-5 text-[#B89A67]" />
//                   <span className="font-semibold text-gray-900">
//                     Carbon Negative Operations by 2026
//                   </span>
//                 </div>
//                 <div className="flex items-center gap-3">
//                   <Cloud className="w-5 h-5 text-[#B89A67]" />
//                   <span className="font-semibold text-gray-900">
...
//               <button className="w-full mt-8 py-4 bg-white text-[#B89A67] font-bold rounded-xl hover:bg-gray-100 transition-colors">
...
//                   <Users className="w-12 h-12 text-[#B89A67] mx-auto mb-6" />
...
//                 <div className="p-8 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
//                   <Globe className="w-12 h-12 text-[#B89A67] mx-auto mb-6" />
...
//                   </div>
//                   <div className="text-gray-400 mt-2">95% waste diverted</div>
//                 </div>

//                 <div className="p-8 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
//                   <Shield className="w-12 h-12 text-[#B89A67] mx-auto mb-6" />
//                   <div className="font-bold text-2xl mb-2">
//                     Quality Assurance
//                   </div>
//                   <div className="text-gray-300 text-lg">GOTS certified</div>
//                   <div className="text-gray-400 mt-2">
...
//               <a href="/collections">
//                 <button className="inline-flex items-center gap-3 px-10 py-4 bg-white text-[#B89A67] font-bold text-lg rounded-full hover:bg-gray-100 transition-colors shadow-lg hover:shadow-xl">
...
//           className="w-full"
//         >
//           <div className="w-full bg-gradient-to-br from-[#B89A67] to-[#D4B483] p-12 rounded-2xl shadow-2xl border-4 border-white text-center relative overflow-hidden">
...
//                 <a
//                   href="/collections"
//                   className="inline-flex items-center justify-center gap-3 px-10 py-4 bg-white text-[#B89A67] font-bold rounded-full hover:bg-gray-100 transition-colors shadow-lg hover:shadow-xl"
//                 >
...
//                 <a
//                   href="/weavers"
//                   className="inline-flex items-center justify-center gap-3 px-10 py-4 bg-white/20 text-white font-bold rounded-full hover:bg-white/30 transition-colors shadow-lg hover:shadow-xl"
//                 >
