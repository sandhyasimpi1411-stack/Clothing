...
const About = () => {
    ...
    <main className="bg-[#FCF9F5] min-h-screen text-[#4A3F35] font-sans selection:bg-[#E3A881] selection:text-white overflow-x-hidden">
      ...
      <section className="py-28 bg-[#A65B3F] text-[#FFF4ED] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
          ...
          {/* UPDATED: Changed lg:items-end to lg:items-center so the text aligns perfectly with the big heading */}
          <div className="flex flex-col lg:flex-row lg:items-center gap-12 mb-20 text-center lg:text-left">
            ...
            {/* UPDATED: Increased text size, changed color to brighter white, and increased max-width to balance the space naturally. */}
  ...
  <p className="relative text-[#FFF4ED] text-xl md:text-2xl font-medium leading-relaxed px-7 py-6 rounded-2xl bg-[#C26D4A]/20 backdrop-blur-sm border border-[#FADACA]/30 shadow-[0_12px_35px_rgba(0,0,0,0.18)] transition-transform duration-300 group-hover:-translate-y-1">
            ...
            {[
              ...
              <FadeIn key={i} delay={i * 0.1}>
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="text-5xl md:text-6xl font-black tracking-tighter mb-4">{s.num}</div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <FadeIn>
            ...
            <a href="/collections" className="inline-block mb-16">
              ...
              whileTap={{ scale: 0.98 }}
              className="cursor-pointer bg-[#A65B3F] text-white px-12 py-5 rounded-full font-bold text-lg flex items-center gap-3 shadow-[0_10px_30px_rgb(166,91,63,0.3)] hover:bg-[#8A462C] transition-colors border border-[#C26D4A]"
              >
